...
class Samsung : Mobile(){
    ...
    override fun models() {
        ...
        print("Samsung Models :  \n  1: Samsung Galaxy A Series. \n  2: Samsung Galaxy Ace Series. \n  3 : Samsung Galaxy C Series.\n  4: Samsung Galaxy Fold Series.\n")
        selected = readln().toInt()
        when(selected)
        {
            1->model ="Samsung Galaxy A Series."
            2->model=" Samsung Galaxy Ace Series."
            3->model= "Samsung Galaxy C Series."
            4->model ="Samsung Galaxy Fold Series."
            else-> print("Number is invalid ")
        }
        stock()
        price()
